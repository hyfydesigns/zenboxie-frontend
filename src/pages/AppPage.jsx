...
const APP_PASSWORD_GUIDES = {
  ...
  "yahoo.com": {
    ...
    steps: [
      ...
      { label: "Copy the password shown and paste it into the App Password field below" },
    ],
    note: "You only need to do this once — Zenboxie saves your App Password encrypted and reconnects automatically.",
  },
  "ymail.com": "yahoo.com",
  "outlook.com": {
    ...
    steps: [
      ...
      { label: "Copy the generated password and paste it into the App Password field below" },
    ],
    note: "You only need to do this once — Zenboxie saves your App Password encrypted and reconnects automatically.",
  },
